...
from .proposal_bundle import router as proposal_bundle_router
...
simula_router.include_router(proposal_bundle_router, tags=["simula", "proposal"])
simula_router.include_router(risk_router, tags=["simula", "risk"])
simula_router.include_router(security_router, tags=["simula", "security"])
